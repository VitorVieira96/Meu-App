...
function App(){
  ...
  //192.168.0.92 Ip Celular porta 40179
  ...
  const[abrirCredencial, setAbrirCredencial] = useState(false);
  ...
  return (
    ...
    <Text style={estilos.textonavbar}>Lista de Contratos</Text>  
    ...
    <TouchableOpacity
      ...
      style={estilos.botao}
      onPress={ () => setAbrirCredencial(true)}
      >
    ...
    <Modal
          animationType="slide"
          transparent={false}
          visible={abrirCredencial}>
    <View style={estilos.navbar}>
      
    <TouchableOpacity
          onPress={ () => setAbrirCredencial(false)}
          >
